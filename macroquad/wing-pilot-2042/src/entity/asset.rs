...
impl Asset {
    pub async fn new(asset_type: AssetType, location: Vec2) -> Self {
        ...
        let clouds = vec![
            format!("{}/resources/cloud1.png", base),
            format!("{}/resources/cloud2.png", base),
            format!("{}/resources/cloud3.png", base),
            format!("{}/resources/cloud4.png", base),
            format!("{}/resources/cloud5.png", base),
        ];
        let grounds = vec![
            format!("{}/resources/ground_1.png", base),
            format!("{}/resources/ground_2.png", base),
            format!("{}/resources/ground_3.png", base),
        ];
