...
pub const PLAYER_PUSH_VALUE: f32 = 2000.; // İleri yönlü hareket halinde mekiğin ne kadar hızlı gideceğine dair sabit
...
pub const ROCK_LIFE: f32 = 1.;
pub const ROCK_BOX_SIZE: f32 = 12.;
